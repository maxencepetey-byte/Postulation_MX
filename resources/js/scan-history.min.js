  ...
  (function() {
    ...
    ready(() => {
      ...
      async function refresh() {
        ...
        try {
          tbody.innerHTML = '<tr><td colspan="5" class="text-center py-4 text-muted">Chargement\u2026</td></tr>';
      ...
      const progressUrl = document.getElementById("gmailProgressWrap") ? document.getElementById("gmailProgressWrap").dataset.url : null;
      ...
      async function pollProgress() {
        ...
        try {
          ...
          if (progressText) {
            progressText.textContent = remaining > 0 ? `${done} / ${total} brouillons cr\xE9\xE9s\u2026 (${remaining} restants)` : `\u2705 ${done} brouillons cr\xE9\xE9s`;
          }
      ...
      if (progressWrap && progressWrap.dataset.active === "1") {
        pollInterval = setInterval(pollProgress, 3e3);
        pollProgress();
      }
